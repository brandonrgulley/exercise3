...
``` {r ttest plot, echo=FALSE, include=TRUE}
...
Figure 1: Bar chart comparing mean body mass in g between males and females of the North American deer mouse.
...
``` {r ANOVA plot, echo=FALSE, include=TRUE}
...
Figure 2: Boxplot comparing hindfoot length between male and female in three different species including the North American deer mouse (PEMA), white-footed mouse (PELE), and marsh rat (ORPA).
...
``` {r ANCOVA plot, echo=FALSE, include=TRUE}
...
Figure 3: Linear regression comparing tail and body length in mm between males and females of the North American deer mouse.